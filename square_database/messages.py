messages = {
    ...
    "INCORRECT_DATABASE_NAME": "the specified database name is incorrect.",
    "INCORRECT_SCHEMA_NAME": "the specified schema name is incorrect.",
    "INCORRECT_TABLE_NAME": "the specified table name is incorrect.",
}
